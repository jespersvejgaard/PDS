...
4		|	R workshop III:	</br> Programmering & Git				| 	[R4DS: kap 17-19](http://r4ds.had.co.nz/program-intro.html), </br> [Leeper (2016): afs 7](https://github.com/leeper/Rcourse/raw/gh-pages/Intro2R/Intro2R.pdf), </br> [van Strien (2016)](https://programminghistorian.org/lessons/getting-started-with-github-desktop) | [Intermediate R](https://www.datacamp.com/courses/intermediate-r) | [R4DS: kap 20-21](http://r4ds.had.co.nz/vectors.html), </br> [Git for data science](https://www.datacamp.com/courses/introduction-to-git-for-data-science), </br> [Intermediate R - practise](https://www.datacamp.com/courses/intermediate-r-practice), </br> [Writing functions](https://www.datacamp.com/courses/writing-functions-in-r), </br> [CS: Apply](https://github.com/rstudio/cheatsheets/raw/master/purrr.pdf), </br> [CS: Advanced R](https://www.rstudio.com/resources/cheatsheets/)
...
### Supplerende & inspirerende litteratur 

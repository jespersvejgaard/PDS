...
4		|	R workshop III:	</br> Programmering & Git				| 
5		|	Web scraping & API										|
6		|	Visualisering I											|
7		|	Visualisering II										|
8		|	Tekst som data											|
